...
- Wilson Rawls was born on September 24, 1913 and passed away on December 16, 1984. He wrote the children's book c". This book is about a young boy and his hunting dogs. It is 245 pages and has a 4/5 rating by Common Sense Media.
...
let WRawls = Author(firstName: "Wilson", lastName: "Rawls", living: false)
let RedFern = Book(title: "Where the Red Fern goes", author: WRawls, pages: 500, numberOfStars: 20.5, description: "Good", genre: "crap")
